...
public class GetRestaurantsNearby extends HttpServlet {
	...
	private static final DBConnection connection = new DBConnection("jdbc:mysql://ec2-52-89-98-152.us-west-2.compute.amazonaws.com:3306/mysql?user=root&password=root");
